    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are an AI that extracts invoice data! Give back all the data, do not skip anything."
                },
                {
                    "role": "user",
                    "content": (
                        "Here is the text of an invoice. Please extract the following information as structured data, do not skip any item!:\n"
